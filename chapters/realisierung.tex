...
Die Realisierung lässt sich in drei Iterationn unterteilen.
...
Wie im Kapitel \ref{methoden} Methoden beschrieben, folgen darauf zwei weitere Iterationn,
...
das sie sich über die Iterationn hinweg erstrecken, 
die Veränderungen über die Iterationn hinweg jedoch nicht weiter relevant sind.
...
Zeitpunkten. Die Messdaten beinhalten neben der Messzeit die drei Iterationn
...
Deshalb wurden Liniendiagramme gewählt. Ein Vortiel dieser ist, dass sicht verschiedene Werte, bspw. die drei Spannungswerte der verschiedenen Iterationn
