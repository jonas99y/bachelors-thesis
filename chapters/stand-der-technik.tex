...
Dazu wird die elektrische Arbeit während 15 Minute gemessen und als einzelner Wert gespeichert. 
Einmal Täglich werden diese Werte vom Elektrizitätswerk ausgelesen. \cite{smart_meter_faq} %4.1
Diese tiefe Auflösung und der träge Ausleseintervall sind gesetzlich festgelegt \cite{admin_strom_VV_art8d}.
...
Ist dies nicht möglich, können die Daten auch über das Mobilfunknetz oder per ADSL übertragen werden. \cite{smart_meter_faq} %1.8
Dazu werden DLMS /COSEM \cite{dlms_cosem} als Kommunikationsschicht verwendet.
Dabei übernehmen die Storzähler die Rolle des Servers. 
Die Kommunikation wird somit nicht von ihm initiiert, sondern von bspw. einem Head End System \cite{hes}.
