...
Diese \ac{CI/CD} Umgebung kann die gesamte Applikation
(Wie im Kapitel \ref{architekturentscheidung} beschrieben) automatisiert bauen und in
danach die gesamte Umgebung starten und testen (Abbildung \ref{fig:ci-env}).
