...
\begin{figure}[h]
    ...
    \caption{
        Architektur des \ac{MQTT} Messagebrokers und des Dataingresses, welcher die
...
Auch der Dataingress verwendet die \texttt{datastore} Python Library. Dies stellt sicher,
